...
dave@dave:/srv/home-server $ cat README.md
# KingyPiNAS
...
- Jellyfin remotely accessible through Cloudflare Tunnel
- Dashboard privately accessible through Cloudflare Access
- Secure remote administration available through Tailscale
...
OpenSSH
    │
KingyPiNAS
Tailscale provides private remote SSH access to KingyPiNAS without exposing SSH publicly or configuring router port forwarding.
SSH public-key authentication is configured for the remote administration laptop.
...
- Continue developing the KingyPiNAS dashboard
- Add stronger service-health monitoring and stale-data detection
